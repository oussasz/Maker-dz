...
# Production API URL
API_URL="https://maker-app-backend-flax.vercel.app/api/category"
...
echo "Adding categories to PRODUCTION database..."
echo "============================================"
...
echo ""
echo "============================================"
echo "Categories added to production!"
echo ""
echo "Fetching all categories from production:"
curl -s "https://maker-app-backend-flax.vercel.app/api/categories" | python3 -m json.tool 2>/dev/null || curl -s "https://maker-app-backend-flax.vercel.app/api/categories"
