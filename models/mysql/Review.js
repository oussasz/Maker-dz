...
export const Review = {
  ...
  async updateById(id, updateData) {
    ...
    if (updateData.rating) { fields.push('rating = ?'); values.push(updateData.rating); }
    ...
    if (updateData.images) { fields.push('images = ?'); values.push(JSON.stringify(updateData.images)); }
